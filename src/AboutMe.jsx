  ...
  return (
    <div className='AboutMe'>
      ...
      <div className='ShortStory' id='short-story'>
        ...
        <p className='storyClrChange'>Being around people has informed my work as a <span>team lead</span>. I have learnt to look for <span>patterns</span> within the work I do so that I can <span>communicate them clearly</span>, which improves the <span>Ai's accuracy</span>. I’ve learnt how to communicate with my manager so that I can <span>fully understand projects</span> that we work on, making sure the <span>turn around</span> of projects are both <span>accurate and rapid</span>, and asking <span>questions</span> or <span>raising concerns</span> so that problems can be dealt with before they turn into disasters. Lastly, I have grown my skills of being able to look at work others completed, both <span>correcting mistakes</span>, but also <span>investigating</span> why those mistakes happened so that <span>new ways of guiding projects</span> can be formulated, allowing my team the time to <span>ask questions</span> and gaining an <span>understanding</span> from their perspective so that we can all <span>grow together</span>.</p>
